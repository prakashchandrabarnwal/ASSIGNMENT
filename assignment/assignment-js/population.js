...
var svg=d3.select("acontent").append("svg").attr({
...
function clearPlot(){
	document.querySelector(".tab-pane acontent").innerHTML="";
	document.querySelector(".tab-pane bcontent").innerHTML="";
