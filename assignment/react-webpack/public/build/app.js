...
/***/ function(module, exports, __webpack_require__) {
	...
	React.render(React.createElement(Main, { headings: headings }), document.getElementById('main'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Headings = __webpack_require__(153);
	var AppBtn = __webpack_require__(155);
	var Rows = __webpack_require__(157);
	var Main = React.createClass({
	    ...
	    mapDataToChangeSet: function mapDataToChangeSet(data) {
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(AppBtn, { fn: this.loadData }),
	            React.createElement(
	                "table",
	                { className: "table" },
	                React.createElement(Headings, { headings: this.props.headings }),
	                React.createElement(Rows, { changeSets: this.state.changeSets, deleteFn: this.deleteData })
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Heading = __webpack_require__(154);
	...
	var Headings = React.createClass({
	    ...
	    render: function render() {
	        var headings = this.props.headings.map(function (name, index) {
	            return React.createElement(Heading, { key: "heading-" + index, heading: name });
	        });
	...
	var AppBtn = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'button',
	                { className: 'btn btn-success', 'data-toggle': 'modal', 'data-target': '#myModal', onClick: this.handleShowModal },
	                'InsertData'
	            ),
	            this.state.view.showModal ? React.createElement(Modal, { handleHideModal: this.handleHideModal, type: 'InsertData' }) : null,
	            React.createElement(
	                'button',
	                { style: headingStyle, className: 'btn btn-success', onClick: this.props.fn },
	                'Search'
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = React.createClass({
	    ...
	    getGender: function getGender(event) {
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'modal fade in', id: 'myModal' },
	                React.createElement(
	                    'div',
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'button',
	                                { type: 'button', className: 'close', 'data-dismiss': 'modal', onClick: this.props.handleHideModal },
	                                '×'
	                            ),
	                            React.createElement(
	                                'h4',
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                ...
	                                React.createElement(
	                                    ...
	                                    React.createElement(
	                                        'label',
	                                        { className: 'col-lg-2', control: true, label: true, 'for': 'inputName' },
	                                        'Name'
	                                    ),
	                                    React.createElement(
	                                        'div',
	                                        { className: 'col-lg-10' },
	                                        React.createElement('input', { className: 'form-control', placeholder: 'Name', type: 'text', onChange: this.getName, value: this.state.name })
	                                    )
	                                ),
	                                React.createElement(
	                                    'div',
	                                    ...
	                                    React.createElement(
	                                        'label',
	                                        { className: 'col-lg-2', control: true, label: true, 'for': 'inputLocation' },
	                                        'Location'
	                                    ),
	                                    React.createElement(
	                                        'div',
	                                        { className: 'col-lg-10' },
	                                        React.createElement('input', { className: 'form-control', id: 'inputLocation', placeholder: 'Location', type: 'text', value: this.state.location, onChange: this.getLocation })
	                                    )
	                                ),
	                                React.createElement(
	                                    'div',
	                                    ...
	                                    React.createElement(
	                                        ...
	                                        React.createElement(
	                                            ...
	                                            React.createElement('input', { name: 'gender', id: 'input-gender-male', value: 'Male', type: 'radio', checked: this.state.checked === 'Male', onChange: this.onChange.bind(this, 'Male') }),
	                                            'Male'
	                                        )
	                                    ),
	                                    React.createElement(
	                                        ...
	                                        React.createElement(
	                                            'label',
	                                            { className: 'radio-inline' },
	                                            React.createElement('input', { name: 'gender', id: 'input-gender-female', value: 'Female', type: 'radio', checked: this.state.checked === 'Female', onChange: this.onChange.bind(this, 'Female') }),
	                                            'Female'
	                                        )
	                                    )
	                                ),
	                                React.createElement(
	                                    ...
	                                    React.createElement(
	                                        'label',
	                                        { className: 'col-lg-2', control: true, label: true, 'for': 'inputPhone' },
	                                        'Phone'
	                                    ),
	                                    React.createElement(
	                                        'div',
	                                        { className: 'col-lg-10' },
	                                        React.createElement('input', { className: 'form-control', id: 'inputPhone', placeholder: 'Phone', value: this.state.phone, type: 'text', onChange: this.getPhone })
	                                    )
	                                ),
	                                React.createElement(
	                                    'div',
	                                    ...
	                                    React.createElement(
	                                        'label',
	                                        { className: 'col-lg-2', control: true, label: true, 'for': 'inputAge' },
	                                        'Age'
	                                    ),
	                                    React.createElement(
	                                        'div',
	                                        { className: 'col-lg-10' },
	                                        React.createElement('input', { className: 'form-control', id: 'inputAge', placeholder: 'Age', value: this.state.age, type: 'text', onChange: this.getAge }),
	                                        this.props.type === "InsertData" ? React.createElement(
	                                            'button',
	                                            { className: 'btn btn-success pull-right', onClick: this.createData },
	                                            'Submit'
	                                        ) : React.createElement(
	                                            'button',
	                                            { className: 'btn btn-success pull-right', onClick: this.updateData },
	                                            'Update'
	                                        )
	                                    )
	                                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rows = React.createClass({
	    ...
	    handleHideModal: function handleHideModal(e) {
	        e.preventDefault();
	        this.setState({ showModal: false });
	    },
	    handleShowModal: function handleShowModal(changeSet, e) {
	        e.preventDefault();
	    ...
	    render: function render() {
	        ...
	        var rows = this.props.changeSets.map(function (changeSet, index) {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'button',
	                        { className: 'btn btn-success', 'data-toggle': 'modal', 'data-target': '#myModal', onClick: this.handleShowModal.bind(this, changeSet) },
	                        'Update'
	                    )
	                ),
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'button',
	                        { className: 'btn btn-danger', onClick: this.props.deleteFn.bind(this, changeSet.ID) },
	                        'Delete'
	                    )
	                )
	            );
	        ...
	        return React.createElement(
	            'tbody',
	            null,
	            this.state.showModal ? React.createElement(Modal, { handleHideModal: this.handleHideModal, data: this.state.changeSet, type: 'Update' }) : null,
	            rows
	        );
	    }
	});
